...
public class COPLanguageProvider extends BlueprintLanguageProvider {
    ...
    protected void addTranslations() {
        ...
        addBlock(COPBlocks.LEAF_PILES.get(WoodMaterial.JACARANDA), "Pile of Jacaranda Leaves");
        addBlock(COPBlocks.LEAF_PILES.get(WoodMaterial.FIR), "Pile of Fir Leaves");
        addBlock(COPBlocks.LEAF_PILES.get(WoodMaterial.REDWOOD), "Pile of Redwood Leaves");
        addBlock(COPBlocks.LEAF_PILES.get(WoodMaterial.MAHOGANY), "Pile of Mahogany Leaves");
        addBlock(COPBlocks.LEAF_PILES.get(WoodMaterial.WILLOW), "Pile of Willow Leaves");
        addBlock(COPBlocks.LEAF_PILES.get(WoodMaterial.MAGIC), "Pile of Magic Leaves");
        addBlock(COPBlocks.LEAF_PILES.get(WoodMaterial.DEAD), "Pile of Dead Leaves");
        addBlock(COPBlocks.LEAF_PILES.get(WoodMaterial.UMBRAN), "Pile of Umbran Leaves");
        addBlock(COPBlocks.LEAF_PILES.get(WoodMaterial.PALM), "Pile of Palm Leaves");
        addBlock(COPBlocks.LEAF_PILES.get(WoodMaterial.HELLBARK), "Pile of Hellbark Leaves");
