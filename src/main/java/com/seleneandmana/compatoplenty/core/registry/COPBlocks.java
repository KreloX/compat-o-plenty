...
public class COPBlocks {
    ...
    static {
        for (var entry : WOOD_PROPERTIES.entrySet()) {
            ...
            HOLLOW_LOGS.put(woodType, HELPER.createHollowLogBlock(materialName, bopBlock(materialName + "_log"), properties.log()));
            ...
            HEDGES.put(woodType, HELPER.createHedgeBlock(materialName + "_hedge", bopBlock(materialName + "_fence"), bopBlock(materialName + "_leaves"), burnTime));
